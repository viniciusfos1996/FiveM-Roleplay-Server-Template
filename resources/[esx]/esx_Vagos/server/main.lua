...
TriggerEvent('esx_society:registerSociety', 'Vagos', 'Vagos', 'society_Vagos', 'society_Vagos', 'society_Vagos', {type = 'whitelisted'})
...
RegisterServerEvent('esx_Vagos:getStockItem')
AddEventHandler('esx_Vagos:getStockItem', function(itemName, count)
...
RegisterServerEvent('esx_Vagos:putStockItems')
AddEventHandler('esx_Vagos:putStockItems', function(itemName, count)
...
ESX.RegisterServerCallback('esx_Vagos:addArmoryWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_Vagos:getStockItems', function(source, cb)
