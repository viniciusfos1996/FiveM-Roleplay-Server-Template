...
Config.Strings = {
	ExitVehicle = "Verlassen Sie das Fahrzeug, um zu tanken",
	EToRefuel = "Drücken Sie ~ g ~ E ~ w ~, um das Fahrzeug zu tanken",
	JerryCanEmpty = "Kanister ist leer",
	FullTank = "Der Tank ist voll",
	PurchaseJerryCan = "Drücken Sie ~ g ~ E ~ w ~, um eine Kanister für ~ g ~ $ zu kaufen" .. Config.JerryCanCost,
	CancelFuelingPump = "Drücken Sie ~ g ~ E ~ w ~, um das Tanken abzubrechen",
	CancelFuelingJerryCan = "Drücken Sie ~ g ~ E ~ w ~, um das Tanken abzubrechen",
	NotEnoughCash = "Nicht genug Geld",
	RefillJerryCan = "Drücken Sie ~ g ~ E ~ w ~, um die Kanister für nachzufüllen",
	NotEnoughCashJerryCan = "Nicht genug Bargeld, um Kanister nachzufüllen",
	JerryCanFull = "Kanister ist voll",
	TotalCost = "Kosten",
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Drücken Sie ~ g ~ E ~ w ~, um eine Kanister zu greifen"
	Config.Strings.RefillJerryCan = "Drücken Sie ~ g ~ E ~ w ~, um die Kanister wieder aufzufüllen"
end
